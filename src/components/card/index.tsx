  ...
  <div className="flex flex-col bg-white border border-gray-200 rounded-lg shadow-md xl:w-[24rem] lg:w-[19rem] md:w-[16rem] w-auto h-full md:mb-0 mb-6">
    ...
    <div className="p-5">
      ...
      <Link
        ...
        className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-secondaryColor rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300"
      >
        Read Blog
        <svg
